...
export function recordSignal({ symbol, name, price, groups, evaluation, at, profileId, profileName, horizon, potential, confidence, exits, dataAge, direction = "buy", entryPrice, exitPrice, stopPrice, levelSource }) {
  ...
  const rec = {
    ...
    levels: { entry: entryPrice ?? null, exit: exitPrice ?? null, stop: stopPrice ?? null, source: levelSource ?? null },
