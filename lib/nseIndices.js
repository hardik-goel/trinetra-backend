...
export const INDICES = {
  ...
  // Broader coverage. Nifty 500 is ~96% of listed market cap and is the widest
  // list NSE publishes with an eligibility bar underneath it — below this the
  // names stop being screenable on fundamentals at all.
  nifty500:    { file: "ind_nifty500list",         group: "Nifty 500",     label: "Nifty 500" },
  midcap150:   { file: "ind_niftymidcap150list",   group: "Midcap 150",    label: "Nifty Midcap 150" },
  smallcap250: { file: "ind_niftysmallcap250list", group: "Smallcap 250",  label: "Nifty Smallcap 250" },
};
